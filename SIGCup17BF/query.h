...
namespace query{
	...
	std::vector<int> onequery(Query query, double *dfsleft, double *dfsdown, std::pair<int, int> *dfsheap, int *dfsstage, char *dfsleftchar, char *dfsdownchar, int *dfsclearsize);
}